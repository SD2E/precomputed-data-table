...
class TestRunPDT(object):
    ...
    def test_latest_er_dir_exists(self, exp_ref_exists):
        expected_er_dir = '20200610192131'
    ...
    def test_data_status_is_good(self, good_exp_ref_dir):
        ...
        good_status = {"fc_raw": "ok. unique sample ids: 1128",
                       "fc_etl": "ok. unique sample ids: 1122",
                       "pr": "ok. unique sample ids: 1410"}
    ...
    def test_fc_no_fc_etl_no_pr(self, exp_ref_exists):
        file_list = os.listdir(os.path.join(self.path_to_complete, exp_ref_exists, '20200610192131'))
